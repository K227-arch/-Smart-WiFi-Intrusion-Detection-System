...
export function AlertsTab({ alerts, onExport }: AlertsTabProps) {
  ...
  return (
    ...
    >
      ...
      <div className="px-6 py-2 border-b border-slate-800 bg-slate-950/30 flex gap-4 text-[10px] text-slate-500 font-mono shrink-0">
        ...
        <span>
          Filtered: <span className="text-sky-400 font-bold">{filtered.length}</span>
        </span>
        <span>
          High:{" "}
            ...
            {filtered.map((a) => {
              ...
              return (
                ...
                >
                  ...
                  <td
                    className="px-6 py-4 font-mono text-[10px] text-sky-400 max-w-[140px] truncate"
                    title={a.targetMac}
                  >
                    {a.targetMac}
                  </td>
